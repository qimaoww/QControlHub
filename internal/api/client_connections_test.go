...
func TestClientConnectionsRejectInvalidQueries(t *testing.T) {
	...
	for _, query := range []string{"locations=invalid", "include_non_public=invalid", "limit=201", "port=65536", "port=0", "before=-1", "engine=unknown", "transport=quic", "client_ip=bad", "since=bad", "bucket=week", "since=2026-01-01T00:00:00Z&until=2026-02-01T00:00:00Z"} {
