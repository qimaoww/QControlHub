...
func TestManagementAPIRouteAuthorizationMatrix(t *testing.T) {
	...
	managementRoutes := []route{
		...
		{http.MethodPut, "/api/v1/substore-sync/settings"}, {http.MethodPut, "/api/v1/substore-sync/selections"}, {http.MethodPost, "/api/v1/substore-sync/test"}, {http.MethodPost, "/api/v1/substore-sync/run"},
