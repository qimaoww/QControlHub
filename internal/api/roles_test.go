...
func TestManagementAPIRouteAuthorizationMatrix(t *testing.T) {
	...
	managementRoutes := []route{
		...
		{http.MethodGet, "/api/v1/substore-sync"},
		{http.MethodPut, "/api/v1/substore-sync/settings"},
		{http.MethodPost, "/api/v1/substore-sync/targets"},
		{http.MethodPost, "/api/v1/substore-sync/targets/sst_test/remote"},
		{http.MethodPut, "/api/v1/substore-sync/targets/sst_test"},
		{http.MethodDelete, "/api/v1/substore-sync/targets/sst_test"},
		{http.MethodPut, "/api/v1/substore-sync/selections"},
		{http.MethodPost, "/api/v1/substore-sync/test"},
		{http.MethodPost, "/api/v1/substore-sync/run"},
