...
func TestGenerateServerConfigurations(t *testing.T) {
	...
	tests := []struct {
		...
		{"singbox vmess", core.EngineSingBox, Input{Protocol: ProtocolVMess, Tag: "vmess-in", Listen: "::", Port: 443, Username: "default", Credential: uuid, Transport: "websocket", TransportPath: "/vmess", TLSEnabled: true, CertificatePath: "/etc/tls/server.crt", PrivateKeyPath: "/etc/tls/server.key"}, []string{`"type": "vmess"`, `"transport"`, `"inbounds"`, `"level": "warn"`}},
