...
func Protocols(engine core.Engine) []Protocol {
	...
	if engine == core.EngineMihomo || engine == core.EngineXray {
		protocols = append(protocols, Protocol{
			Key: ProtocolVLESSXHTTP, Name: "VLESS-XHTTP-uTLS-REALITY", Badge: "VLESS XHTTP",
	...
	if engine == core.EngineMihomo || engine == core.EngineXray {
		protocols = append(protocols,
			Protocol{
				Key: ProtocolVLESSEncTCP, Name: "VLESS-ENC-TCP-Vision-uTLS-REALITY", Badge: "VLESS ENC TCP",
			...
			Protocol{
				Key: ProtocolVLESSEncXHTTP, Name: "VLESS-ENC-XHTTP-Vision-uTLS-REALITY", Badge: "VLESS ENC XHTTP",
