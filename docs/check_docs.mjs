...
const files = ["README.md", "docs/api.md", "docs/production.md", "docs/security.md", "docs/ip-quality.md"]
...
const required = {
  ...
  "docs/ip-quality.md": ["ip-quality-v2", "AGPL-3.0", "SHA-256", "128 KiB", "schema 65", "第三方网络请求", "SVG", "面板数据库"],
};
