...
function contextMarkup(title) {
  ...
  if (state.route === "ip-quality")
    return `<nav class="context-menu" aria-label="IP 质量检测目录"><a class="active" href="#ip-quality"><span>01</span>按日期查看</a><a href="#ip-quality"><span>02</span>节点评分</a><a href="#ip-quality"><span>03</span>风险与解锁</a></nav><p class="context-note">数据来源：IPQuality 检测任务</p>`;
