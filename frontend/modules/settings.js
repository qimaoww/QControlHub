...
async function settings() {
  ...
  document.querySelectorAll("[data-user-role]").forEach((select) => {
    select.addEventListener("change", () => togglePermissionEditor(select, select.closest("[data-user-form]")?.querySelector("[data-permission-editor]")));
  });
  const createRole = document.querySelector("[data-create-role]");
  createRole?.addEventListener("change", () => togglePermissionEditor(createRole, document.querySelector("#user-create-form [data-permission-editor]")));
