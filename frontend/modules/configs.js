...
async function agentConfig() {
  ...
  const executionCallout = !engineInstalled
    ? `<aside class="config-execution-callout"><span><b>${esc(engineName(engine))} 尚未安装</b><small>可以编辑方案，但校验、部署和服务操作需要先在节点页安装该内核。</small></span><a class="button small" href="#agents">前往安装内核</a></aside>`
    : "";
  shell(
