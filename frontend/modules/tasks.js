...
async function tasks() {
  ...
  // Polling rebuilds the task timeline. Keep the user's result panels open
  // across that rebuild instead of letting each refresh collapse them.
  const openResultTaskIds = new Set(
    [...document.querySelectorAll("[data-task-id] details[data-task-result][open]")]
